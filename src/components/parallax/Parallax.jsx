...
function ParallaxSection() {
    ...
    return (
        <div ref={sceneRef} className="relative overflow-hidden 2xl:h-[100vh] 3xl:h-auto">
            <div>
            ...
            <div data-depth="0.05" className="w-full h-full">
                <img src={BigCloud} alt="cloud" loading="lazy" className="w-full absolute z-[2] bottom-[120px] scale-[1.1]" />
            </div>
            <div data-depth="0.05" className="w-full h-full">
            ...
            <div data-depth="0.30" className="w-full h-full">
                <img src={Ship} alt="ship" loading="lazy" className="ship w-[150px] md:w-[200px] lg:w-[300px] xl:w-[400px] 2xl:w-[500px] absolute z-[8] left-[-90px] md:left-0 2xl:left-[50px] bottom-[50px] xl:bottom-[60px]" />
            </div>
